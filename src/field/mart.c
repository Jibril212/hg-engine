...
u16 sVioletCityMart[] = {
    ITEM_TUNNEL_MAIL, ITEM_DREAM_BALL, ITEM_NET_BALL, 0xFFFF
};

u16 sAzaleaCityMart[] = {
    ITEM_BLOOM_MAIL, ITEM_CHERISH_BALL, ITEM_NET_BALL, 0xFFFF
};
...
u16 sEcruteakMart[] = {
    ITEM_LONELY_MINT, ITEM_ADAMANT_MINT, ITEM_NAUGHTY_MINT, ITEM_BRAVE_MINT, ITEM_BOLD_MINT, ITEM_IMPISH_MINT, ITEM_LAX_MINT, ITEM_RELAXED_MINT, ITEM_MODEST_MINT, ITEM_MILD_MINT, ITEM_RASH_MINT, ITEM_QUIET_MINT, ITEM_CALM_MINT, ITEM_GENTLE_MINT, ITEM_CAREFUL_MINT, ITEM_SASSY_MINT, ITEM_TIMID_MINT, ITEM_HASTY_MINT, ITEM_JOLLY_MINT, ITEM_NAIVE_MINT, ITEM_SERIOUS_MINT, ITEM_SWAMPERTITE, ITEM_SABLENITE, ITEM_ALTARIANITE, ITEM_GALLADITE, ITEM_AUDINITE, ITEM_METAGROSSITE, ITEM_SHARPEDONITE, ITEM_SLOWBRONITE, ITEM_STEELIXITE, ITEM_PIDGEOTITE, ITEM_GLALITITE, ITEM_CAMERUPTITE, ITEM_LOPUNNITE, ITEM_SALAMENCITE, ITEM_BEEDRILLITE, ITEM_GENGARITE, ITEM_GARDEVOIRITE, ITEM_AMPHAROSITE, ITEM_VENUSAURITE, ITEM_BLASTOISINITE, ITEM_BLAZIKENITE, ITEM_MEDICHAMITE, ITEM_HOUNDOOMINITE, ITEM_AGGRONITE, ITEM_BANETTITE, ITEM_TYRANITARITE, ITEM_SCIZORITE, ITEM_PINSIRITE, ITEM_AERODACTYLITE, ITEM_LUCARIONITE, ITEM_ABOMASITE, ITEM_KANGASKHANITE, ITEM_GYARADOSITE, ITEM_ABSOLITE, ITEM_CHARIZARDITE_X, ITEM_ALAKAZITE, ITEM_HERACRONITE, ITEM_MAWILITE, ITEM_GARCHOMPITE, 0xFFFF 
	
};

u16 sOlivineMart[] = {
    ITEM_HEART_MAIL, ITEM_DREAM_BALL, ITEM_NET_BALL, 0xFFFF
};
